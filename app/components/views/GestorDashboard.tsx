    ...
    <>
      <header className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <Image
            src="https://i.pravatar.cc/40?u=gestora"
            alt="Avatar da gestora"
            width={40}
            height={40}
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg lg:col-span-2">
          <h3 className="text-lg font-semibold text-gray-500">
            Eficiência e Anomalias
          </h3>
          <div className="flex items-center justify-center h-full mt-4">
            <Image
              src="https://news-images.weatherzone.com.au/WAheatplacesFeb3.png"
              alt="Gráfico de mapa de calor"
              width={500}
              height={256}
              className="object-contain max-h-64 rounded-md"
            />
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <h3 className="text-lg font-semibold text-gray-500">
            Alertas Críticos - Volume por Dia
          </h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <h3 className="text-lg font-semibold text-gray-500">
            Alertas Críticos - Tipos
          </h3>
          <ul className="mt-4 space-y-3">
            <li className="p-3 bg-red-100 text-red-800 rounded-lg font-medium">
              Descarte Irregular (15)
            </li>
            <li className="p-3 bg-orange-100 text-orange-800 rounded-lg font-medium">
              Coleta Atrasada (8)
            </li>
            <li className="p-3 bg-yellow-100 text-yellow-800 rounded-lg font-medium">
              Lixeira Cheia (5)
            </li>
            <li className="p-3 bg-gray-100 text-gray-800 rounded-lg font-medium">
              Veículo Quebrado (2)
            </li>
          </ul>
        </div>
